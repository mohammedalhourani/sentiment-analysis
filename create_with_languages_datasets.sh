...
mvn compile exec:java \
 ...
 -Dexec.args="--project=$PROJECT --region=us-central1 --bucket=$BUCKET --dataset=$DATASETNAME --table=$TABLENAME --maxNumWorkers=$MAX_NUM_WORKERS --autoscalingAlgorithm=THROUGHPUT_BASED --workerMachineType=c2-standard-8"
